...
pub enum SourceProbeKey {
    ...
    StorageBackupDownloadReadiness,
    StorageBackupUploadReadiness,
    StorageDataDir,
    StorageDebug,
    StorageExists,
    StorageManifests,
...
impl SourceProbeKey {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::StorageBackupDownloadReadiness => "backupDownloadReadiness",
            Self::StorageBackupUploadReadiness => "backupUploadReadiness",
