mod adapters {
    ...
    pub(crate) use basecamp::{
        DELIVERY_MODULE, STORAGE_MODULE, call_value, delivery_lifecycle_args,
        delivery_message_args, dispatch_result, is_storage_module_source, storage_args,
    };
    ...
    pub(crate) use rest::{
        delivery_store_query_url, raw_http_json_url, rest_empty_request, rest_json_request,
