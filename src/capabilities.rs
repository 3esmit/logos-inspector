...
use availability::{
    CapabilityState, append_unique, available_state, capability_state_usable, input_required_state,
    loading_state, merge_state_constraints, state_from_unavailable, state_marks_unavailable,
    unavailable_state,
};
use catalog::{
...
use diagnostics_evidence::diagnostics_state;
