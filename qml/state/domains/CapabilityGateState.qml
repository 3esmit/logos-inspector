import QtQml
import "../capabilities/CapabilityGateIntents.js" as CapabilityGateIntents
...
QtObject {
    ...
    function programDecodeGate(options) {
        return gateFor(programDecodeDependency(), options || {})
    }
    ...
    function storageDependency(action) {
        return CapabilityGateIntents.storageDependency(action)
    }

    function deliveryDependency(action) {
        return CapabilityGateIntents.deliveryDependency(action)
    }

    function diagnosticsDependency(action) {
        return CapabilityGateIntents.diagnosticsDependency(action)
    }

    function socialDependency(action) {
        return CapabilityGateIntents.socialDependency(action)
    }

    function walletDependency(action) {
        return CapabilityGateIntents.walletDependency(action)
    }

    function programDecodeDependency() {
        return CapabilityGateIntents.programDecodeDependency()
    }
