...
function selectorLabels() {
    return {
        "network.network": qsTr("Network"),
        "network.chain_id": qsTr("Bedrock chain ID"),
        "network.zone_id": qsTr("Execution Zone ID"),
        "network.channel_id": qsTr("Active Channel ID"),
        "network.report_time": qsTr("Last report time"),
        "bedrock.node_health": qsTr("Node health"),
        "bedrock.peer_count": qsTr("Connected peers"),
        "bedrock.sync_state": qsTr("Sync status"),
        "bedrock.tip_height": qsTr("Tip height"),
        "bedrock.tip_hash": qsTr("Tip hash"),
        "bedrock.lib_height": qsTr("Last irreversible block height"),
        "bedrock.lib_hash": qsTr("Last irreversible block hash"),
        "bedrock.tip_minus_lib": qsTr("Tip-to-LIB gap"),
        "bedrock.last_tip_time": qsTr("Last tip observation"),
        "bedrock.last_lib_time": qsTr("Last LIB observation"),
        "bedrock.finality_lag_seconds": qsTr("Finality lag"),
        "lez.rpc_health": qsTr("Sequencer RPC health"),
        "lez.sequencer_version": qsTr("Sequencer version"),
        "lez.last_lez_block_id": qsTr("Latest Sequencer block ID"),
        "lez.last_lez_block_hash": qsTr("Latest Sequencer block hash"),
        "lez.last_lez_block_time": qsTr("Latest Sequencer block time"),
        "lez.pending_tx_count": qsTr("Pending transactions"),
        "lez.mempool_tx_count": qsTr("Mempool transactions"),
        "lez.rejected_tx_count_recent": qsTr("Recent rejected transactions"),
        "lez.blocks_produced_recent": qsTr("Provisional block records"),
        "lez.publish_to_bedrock_status": qsTr("Bedrock publication status"),
        ...
        "lez.pending_blocks_count": qsTr("Pending Sequencer blocks"),
        "indexer.rpc_health": qsTr("Indexer RPC health"),
        ...
        "indexer.indexer_lag_vs_sequencer_head": qsTr("Indexer lag behind Sequencer"),
        "indexer.last_indexed_time": qsTr("Last indexed time"),
        "indexer.db_health": qsTr("Database health"),
        "indexer.ingestion_status": qsTr("Ingestion status"),
        "storage.module": qsTr("Storage source status"),
        "storage.network": qsTr("Storage network"),
        "storage.node_reachable": qsTr("Storage node reachability"),
        "storage.nat_mode": qsTr("NAT mode"),
        "storage.udp_discovery_port": qsTr("UDP discovery port"),
        "storage.tcp_transfer_port": qsTr("TCP transfer port"),
        "storage.peer_count": qsTr("Storage peers"),
        "storage.dht_connected": qsTr("DHT connection"),
        "storage.shared_files_count": qsTr("Shared files"),
        "storage.manifest_count": qsTr("Manifests"),
        "storage.local_storage_used": qsTr("Local storage used"),
        "storage.active_uploads": qsTr("Total upload requests"),
        "storage.active_downloads": qsTr("Total download requests"),
        "storage.failed_transfers_recent": qsTr("Recent transfer failures"),
        "storage.failed_transfers_total": qsTr("Total transfer failures"),
        "storage.cid_fetch_test": qsTr("CID fetch test"),
        "storage.last_error": qsTr("Last storage error"),
        "messaging.module": qsTr("Delivery source status"),
        "messaging.connection_state": qsTr("Delivery connection"),
        "messaging.peer_count": qsTr("Delivery peers"),
        "messaging.active_subscriptions": qsTr("Active subscriptions"),
        "messaging.content_topics": qsTr("Content topics"),
        "messaging.outbound_queue": qsTr("Outbound queue"),
        "messaging.message_sent_events_recent": qsTr("Recent sent-message events"),
