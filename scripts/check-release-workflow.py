...
FORK_INPUTS = {
    "blockchain_module": (
        ...
        "405e4d859fcc3cf71b962df06146dfee8358e3d0",
    ),
    "storage_module": (
    ...
    "lez_core": (
        ...
        "3523af62f5146e9a4295c93550289a279ec18f62",
    ),
    "lez_indexer_module": (
...
def main() -> int:
    ...
    if "xcodebuild -importComponent MetalToolchain" in standalone:
        errors.append(
            "standalone release workflow must not import a Metal component on Xcode 26"
        )
    require(
        cli,
        (
    ...
    require(
        ...
        (
            ...
            "publish-aggregate:",
            "gh release upload",
            "logos_inspector_ui-sidecar.json",
            "Verify canonical Inspector tag contains every artifact class",
            "standalone_release.py verify",
